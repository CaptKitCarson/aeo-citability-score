...
Tags: seo, aeo, ai search, chatgpt, perplexity
...
Score every post on the factors that actually drive AI citation in Google AI Overviews, ChatGPT and Perplexity.
...
No. Structural scoring is pure PHP, with no external calls. Runs on save (async at the WP level). AI rubric only runs when you explicitly click "Run AI analysis" in the editor.
